...
// Configure axios base URL to your backend. If running on a mobile device
// you need to use your local network IP address instead of localhost.
// To find your IP: Windows: ipconfig | findstr IPv4, Mac/Linux: ifconfig or ip addr
const API_BASE_URL = __DEV__ 
  ? 'http://192.168.68.61:3000'  // Change this to your local IP address
